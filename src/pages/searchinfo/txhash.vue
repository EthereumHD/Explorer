                        ...
                        <ul>
                            ...
                            <li>
                                <div>
                                    ...
                                    <span>{{ form.actualTxCost | formatNum(-18, 4) }} {{ $store.state.projectName }} (${{ EhdValue | formatNum(-18, 2) }})</span>
                                </div>
                                <div>
                                    <p>Nonce & {Position}:</p>
...
export default {
    ...
    methods: {
        getDetail() {
            ...
            if (that.form.Txhash.startsWith("ehd")) {
                that.form.Txhash = that.form.Txhash.replace("ehd", "0x");
            }
